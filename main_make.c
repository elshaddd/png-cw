...
//    struct Png image2;
//    struct Png result;
//    read_png_file("test2.png", &image1);
//    read_png_file("test2_1.png", &image2);
//    merge(&image1,&image2,&result);
//    write_png_file("test2_mer.png",&result);
    ...
    if (f_function) {
        // ADD FUNC HERE
//        example
//        png_color colorr = {255,255,255};
//        struct Png result;
//        read_png_file("kub.png",&image1);
//        read_png_file("screen2.png",&image2);
//        vert_concat(&image1,&image2,&result);
